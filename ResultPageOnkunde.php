...
maar een teveel aan <?php echo $inputs["input6"]; ?>. <br> Te veel <?php echo $inputs["input6"]; ?> leidt tot <?php echo $inputs["input7"]; ?> en dat is niet goed als je wilt
<?php echo $inputs["input1"]; ?>. <br> Helaas voor <?php echo $inputs["input2"]; ?>.
</p>